...
If you want to contribute translations for a language that is not yet available on the Crowdin Project, please reach out
to any the team members of our [Discord](https://discord.gg/hmaD7Se) server.

In case you provided translations to us before, we ask you to please also use the Crowdin platform in the future instead
of creating PRs.
Should you have created a modified .json file with translations like outlined by this document before please reach out
to Zelophed#0341 on Discord.
